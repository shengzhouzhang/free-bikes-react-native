...
describe('Input Component', () => {
  ...
  describe('render TextInput', () => {
    ...
    it('should render TextInput and provide the value and onChange handler', () => {
      ...
      expect(wrapper.find(React.TextInput).prop('onChange')).to.eql(wrapper.instance().onTextChangeHandler);
    });
  });
